...
@endpush
@push('scripts')
    <script src="/js/admin/packagedetail/index.js"></script>
...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card direct-chat direct-chat-primary">
                <div class="card-header ui-sortable-handle header-color" style="cursor: move;">
                    <h3 class="card-title text-bold">Thêm chi tiết gói</h3>
                ...
                <div class="card-body" style="display: block;padding: 10px !important;">
                    <form action="{{ route('admin.packagedetails.store') }}" method="POST">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="price_sale"
                                            value="{{ old('price_sale') }}" placeholder="Nhập giá sale">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card direct-chat direct-chat-primary">
                <div class="card-header ui-sortable-handle header-color" style="cursor: move;">
                    <h3 class="card-title text-bold">Danh sách chi tiết gói</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-minus"></i>
                        </button>
